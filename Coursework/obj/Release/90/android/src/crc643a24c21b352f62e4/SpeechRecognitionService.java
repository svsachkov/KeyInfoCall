...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Coursework.SpeechRecognitionService, Coursework", SpeechRecognitionService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SpeechRecognitionService.class)
			mono.android.TypeManager.Activate ("Coursework.SpeechRecognitionService, Coursework", "", this, new java.lang.Object[] {  });
	}
