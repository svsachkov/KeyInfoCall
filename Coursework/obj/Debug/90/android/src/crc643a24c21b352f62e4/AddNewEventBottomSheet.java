...
public class AddNewEventBottomSheet
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Coursework.AddNewEventBottomSheet, Coursework", AddNewEventBottomSheet.class, __md_methods);
	}


	public AddNewEventBottomSheet ()
	{
		super ();
		if (getClass () == AddNewEventBottomSheet.class)
			mono.android.TypeManager.Activate ("Coursework.AddNewEventBottomSheet, Coursework", "", this, new java.lang.Object[] {  });
	}

	public AddNewEventBottomSheet (crc643a24c21b352f62e4.CallsInfoActivity p0, android.content.Context p1)
	{
		super ();
		if (getClass () == AddNewEventBottomSheet.class)
			mono.android.TypeManager.Activate ("Coursework.AddNewEventBottomSheet, Coursework", "Coursework.CallsInfoActivity, Coursework:Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
