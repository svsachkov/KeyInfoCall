...
public class KeyInfoCallAccessibilityService
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Coursework.KeyInfoCallAccessibilityService, Coursework", KeyInfoCallAccessibilityService.class, __md_methods);
	}


	public KeyInfoCallAccessibilityService ()
	{
		super ();
		if (getClass () == KeyInfoCallAccessibilityService.class)
			mono.android.TypeManager.Activate ("Coursework.KeyInfoCallAccessibilityService, Coursework", "", this, new java.lang.Object[] {  });
	}
